		    		...
		    		success: function() // Success
		 			{  
			   		...
			   		error: function() // Fail
			   		{
						...
						{
							$form.append("<div id='form-alert'><div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><strong>"+'Notre système de contact est temporairement indisponible'+"</strong></div></div>");
						}	
			   		},
		   		});
			}
